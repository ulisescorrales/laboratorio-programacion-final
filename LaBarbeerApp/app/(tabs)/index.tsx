...
export default function HomeScreen() {
	...
	useEffect(()=>{
		fetch('http://192.168.1.12:3000/api/cervezas').then(data=>data.json()).then(json=>setColCervezas(json));
		fetch('http://192.168.1.12:3000/api/cortes').then(data=>data.json()).then(json=>setColCortes(json));
	},[])
  return (
